...
<html lang="en">
 ...
 <h1 align="center" > <span class="text-white">Student Management System</span> </h1>
                                ...
                                <div class="col-md-10 col-md-offset-1 pt-50">
                                    ...
                                    <div class="row mt-30 ">
                                        <div class="col-md-11">
                                            ...
                                            <!-- /.panel -->
                                            <div >
                                                <p class="text-center text-white ">Copyright © Student Managnent System Devloper Nur & Jakir </p>
                                            </div>
                                        </div>
                                        <!-- /.col-md-11 -->
                                    </div>
